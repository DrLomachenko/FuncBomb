...
\begin{document}
	...
	\section*{0. Важное из первого семестра}
	...
	\begin{enumerate}
		...
		\item Для $G$ берём функционал Минковского $\mu_G(x)=\inf\{t>0:x/t\in G\}$; он положительно однороден по определению и полуаддитивен по выпуклости.
